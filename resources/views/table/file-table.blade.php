<table class="table align-items-center mb-0" id="file-search-result">
    ...
    @foreach ($files as $fil)
        <tr>                                  
            ...
            @if(Auth::user()->type == 1)
            <td class="text-center" oldfile='{{ $fil->filename }}'>
                <a href="#" id="edit-file" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                    <i class="fas fa-user-edit text-secondary"></i>
                </a>
                <a href="#" id="delete-file" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Delete">
